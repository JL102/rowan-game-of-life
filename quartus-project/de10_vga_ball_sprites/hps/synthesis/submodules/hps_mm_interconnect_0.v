...
module hps_mm_interconnect_0 (
	...
	wire  [118:0] switch_s1_agent_rf_source_data;                                               // switch_s1_agent:rf_source_data -> switch_s1_agent_rsp_fifo:in_data
	...
	wire  [118:0] switch_s1_agent_rsp_fifo_out_data;                                            // switch_s1_agent_rsp_fifo:out_data -> switch_s1_agent:rf_sink_data
	...
	wire  [117:0] hex3_s1_agent_rp_data;                                                        // hex3_s1_agent:rp_data -> router_006:sink_data
	...
	wire  [117:0] hex4_s1_agent_rp_data;                                                        // hex4_s1_agent:rp_data -> router_007:sink_data
	...
	wire  [117:0] hex5_s1_agent_rp_data;                                                        // hex5_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [117:0] buttons_s1_agent_rp_data;                                                     // buttons_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [117:0] switch_s1_agent_rp_data;                                                      // switch_s1_agent:rp_data -> router_010:sink_data
	...
	wire  [117:0] cmd_mux_004_src_data;                                                         // cmd_mux_004:src_data -> hex3_s1_burst_adapter:sink0_data
	wire          cmd_mux_004_src_ready;                                                        // hex3_s1_burst_adapter:sink0_ready -> cmd_mux_004:src_ready
	wire    [8:0] cmd_mux_004_src_channel;                                                      // cmd_mux_004:src_channel -> hex3_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] hex3_s1_burst_adapter_source0_channel;                                        // hex3_s1_burst_adapter:source0_channel -> hex3_s1_agent:cp_channel
	...
	wire  [117:0] cmd_mux_005_src_data;                                                         // cmd_mux_005:src_data -> hex4_s1_burst_adapter:sink0_data
	wire          cmd_mux_005_src_ready;                                                        // hex4_s1_burst_adapter:sink0_ready -> cmd_mux_005:src_ready
	wire    [8:0] cmd_mux_005_src_channel;                                                      // cmd_mux_005:src_channel -> hex4_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] hex4_s1_burst_adapter_source0_channel;                                        // hex4_s1_burst_adapter:source0_channel -> hex4_s1_agent:cp_channel
	...
	wire  [117:0] cmd_mux_006_src_data;                                                         // cmd_mux_006:src_data -> hex5_s1_burst_adapter:sink0_data
	wire          cmd_mux_006_src_ready;                                                        // hex5_s1_burst_adapter:sink0_ready -> cmd_mux_006:src_ready
	wire    [8:0] cmd_mux_006_src_channel;                                                      // cmd_mux_006:src_channel -> hex5_s1_burst_adapter:sink0_channel
	...
	wire    [8:0] hex5_s1_burst_adapter_source0_channel;                                        // hex5_s1_burst_adapter:source0_channel -> hex5_s1_agent:cp_channel
	...
	wire  [117:0] cmd_mux_007_src_data;                                                         // cmd_mux_007:src_data -> buttons_s1_burst_adapter:sink0_data
	wire          cmd_mux_007_src_ready;                                                        // buttons_s1_burst_adapter:sink0_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                      // cmd_mux_007:src_channel -> buttons_s1_burst_adapter:sink0_channel
	...
	wire          cmd_mux_008_src_valid;                                                        // cmd_mux_008:src_valid -> switch_s1_burst_adapter:sink0_valid
	wire  [117:0] cmd_mux_008_src_data;                                                         // cmd_mux_008:src_data -> switch_s1_burst_adapter:sink0_data
	wire          cmd_mux_008_src_ready;                                                        // switch_s1_burst_adapter:sink0_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                      // cmd_mux_008:src_channel -> switch_s1_burst_adapter:sink0_channel
	wire          cmd_mux_008_src_startofpacket;                                                // cmd_mux_008:src_startofpacket -> switch_s1_burst_adapter:sink0_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                  // cmd_mux_008:src_endofpacket -> switch_s1_burst_adapter:sink0_endofpacket
	wire          switch_s1_burst_adapter_source0_valid;                                        // switch_s1_burst_adapter:source0_valid -> switch_s1_agent:cp_valid
	wire  [117:0] switch_s1_burst_adapter_source0_data;                                         // switch_s1_burst_adapter:source0_data -> switch_s1_agent:cp_data
	...
	wire          buttons_s1_agent_rdata_fifo_out_valid;                                        // buttons_s1_agent_rdata_fifo:out_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] buttons_s1_agent_rdata_fifo_out_data;                                         // buttons_s1_agent_rdata_fifo:out_data -> avalon_st_adapter_007:in_0_data
	wire          buttons_s1_agent_rdata_fifo_out_ready;                                        // avalon_st_adapter_007:in_0_ready -> buttons_s1_agent_rdata_fifo:out_ready
